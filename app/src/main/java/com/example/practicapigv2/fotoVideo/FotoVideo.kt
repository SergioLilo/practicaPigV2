...
class FotoVideo : AppCompatActivity() {
    private lateinit var viewBinding: ActivityFotoVideoBinding
    ...
    private fun takePhoto() {
        ...
        val contentValues = ContentValues().apply {
            ...
            if(Build.VERSION.SDK_INT > Build.VERSION_CODES.P) {
                put(MediaStore.Images.Media.RELATIVE_PATH, "Pictures/"+nombreUsu)
            }
        }
    ...
    private fun captureVideo() {
        ...
        val contentValues = ContentValues().apply {
            ...
            if (Build.VERSION.SDK_INT > Build.VERSION_CODES.P) {
                put(MediaStore.Video.Media.RELATIVE_PATH, "Movies/"+nombreUsu)
            }
        }
        ...
        recording = videoCapture.output
            ...
            .apply {
                if (PermissionChecker.checkSelfPermission(this@FotoVideo,
